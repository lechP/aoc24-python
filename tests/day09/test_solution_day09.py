...
from solutions.day09.solution_day09 import count_checksum, count_checksum_v2
...
class TestDay07Unit(unittest.TestCase):
    ...
    def test_count_checksum_v2(self):
        self.assertEqual(2858, count_checksum_v2("2333133121414131402"))
...
class TestDay07Solution(unittest.TestCase):
    ...
    def test_total_calibration_result_v2(self):
        input_test_1 = read("test1.txt")
        self.assertEqual(2858, count_checksum_v2(input_test_1))

    def test_result_on_real_input_part2(self):
        _input = read("input.txt")
        print(count_checksum_v2(_input))
